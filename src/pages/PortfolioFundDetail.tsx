...
const SAMPLE_PORTFOLIO = {
  ...
  description:
    "Supporting climate action and conservation projects across multiple organizations focused on environmental conservation, renewable energy, and sustainable practices.",
...
const SAMPLE_CHARITIES = [
  ...
  },
  {
    ...
    category: "Environmental",
    image:
      "https://images.unsplash.com/photo-1474511320723-9a56873867b5?auto=format&fit=crop&w=800",
    verified: true,
    country: "Kenya",
    causes: [],
  },
  {
    ...
    category: "Environmental",
    image:
      "https://images.unsplash.com/photo-1495107334309-fcf20504a5ab?auto=format&fit=crop&w=800",
    verified: true,
    country: "India",
    causes: [],
  },
