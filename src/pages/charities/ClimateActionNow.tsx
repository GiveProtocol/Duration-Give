...
const ClimateActionNow: React.FC = () => {
  const charity = {
    ...
    description: 'Fighting climate change globally through renewable energy initiatives, reforestation projects, and sustainable community development.',
    ...
    mission: 'Our mission is to combat climate change through direct action, education, and sustainable community development.',
    impact: [
