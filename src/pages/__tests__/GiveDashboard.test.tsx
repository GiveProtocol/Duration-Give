    ...
    filterSort: [
      {
        ...
        selector: "dashboard.filters.allYears",
      },
      {
        element: "type filter dropdown",
        selector: "dashboard.filters.allTypes",
      },
    ],
    modals: [
      {
        name: "export",
        button: "dashboard.exportData",
        testId: "export-modal",
      },
      {
        name: "wallet settings",
        button: "dashboard.walletSettings",
        testId: "wallet-settings",
      },
      {
        name: "scheduled donations",
        button: "dashboard.scheduledDonations",
        testId: "scheduled-donations",
      },
    ],
    statistics: [
