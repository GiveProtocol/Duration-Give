      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <ul>
            ...
            <li>Transparency in charitable giving through blockchain verification</li>
          </ul>
        ...
        <section>
          ...
          <ul>
            ...
            <li>- Complete any required verification processes truthfully and accurately</li>
        ...
        <section>
          ...
          <ul>
            ...
            <li>- Any platform fees as disclosed prior to transaction execution</li>
