  ...
  return (
    ...
    >
      <div className="space-y-8">
        <section>
          <h2>
            <strong>1. INTRODUCTION AND BINDING AGREEMENT</strong>
          </h2>

          <p>
            Welcome to the Give Protocol decentralized application ("dApp").
            These Terms and Conditions ("Terms") constitute a legally binding
            agreement between you ("User," "you," or "your") and Give Protocol
            Foundation ("Give Protocol," "Company," "we," "us," or "our")
            governing your access to and use of the Give Protocol dApp,
            including all related services, features, content, and functionality
          ...
          <p>
            ...
            Terms. If you don&apos;t agree to these Terms, you must not access
            or use the Services. Your use of the Services in any way means that
            you agree to all of these Terms, and these Terms will remain in
          ...
          <ImportantNotice variant="warning">
            <p>
              ...
              important information about Services provided to you and any
              charges we bill you. These Terms include information about future
              changes to these Terms, limitations of liability, a class action
              waiver, and resolution of disputes by arbitration instead of in
              court.
            </p>
          </ImportantNotice>
        ...
        <section>
          ...
          <p>
            We reserve the right to modify these Terms at any time by posting
            the revised Terms on the Platform. We will place a notice on our
            site, send you an email, and/or notify you by some other means when
            we make changes.
          </p>
          ...
          <p>
            ...
            The changes will not be retroactive, and the most current version of
            the Terms will govern our relationship with you.
          </p>
        ...
        <section>
          <h2>
            <strong>3. PLATFORM OVERVIEW</strong>
          </h2>
          ...
          <ul>
            <li>
              Cryptocurrency donations to verified charitable organizations
            </li>
          ...
          <ImportantNotice variant="warning">
            <p>
              <strong>IMPORTANT NOTICE:</strong> Give Protocol Foundation is a
              not-for-profit charitable organization that has developed this
              platform to facilitate charitable giving, charitable equity, and
              volunteering. Give Protocol does not offer financial or other
              advice, and is not a bank or financial institution. We do not
              provide financial services or financial market infrastructure. We
              serve as a technological bridge connecting donors, volunteers, and
        ...
        <section>
          <h2>
            <strong>4. ELIGIBILITY AND ACCOUNT REQUIREMENTS</strong>
          </h2>

          <h3>
            <strong>4.1 Eligibility Requirements</strong>
          </h3>
          ...
          <h3>
            <strong>4.2 Wallet Requirements</strong>
          </h3>
          ...
          <ul>
            ...
            <li>
              - Ensuring your wallet complies with applicable laws and
              regulations
            </li>
          </ul>

          <h3>
            <strong>4.3 Account Information</strong>
          </h3>

          <p>
            You promise to provide us with accurate, complete, and updated
            information about yourself. You may not select as your User ID a
            name that you don&apos;t have the right to use, or another
          ...
          <p>
            ...
            agree to these Terms on that organization&apos;s or entity&apos;s
          ...
          <p>
            ...
            otherwise use the Services or send us any personal information. If
            we learn we have collected personal information from a child under
            18 years of age, we will delete that information as quickly as
            possible. If you believe that a child under 18 years of age may have
        ...
        <section>
          <h2>
            <strong>5. CRYPTOCURRENCY DONATIONS</strong>
          </h2>

          <h3>
            <strong>5.1 Transaction Execution</strong>
          </h3>
          ...
          <h3>
            <strong>5.2 Role of Give Protocol</strong>
          </h3>

          <p>
            Give Protocol Foundation, as a not-for-profit charitable
            organization, connects charitable organizations with those looking
            to donate cryptocurrency and other assets. When we use the word
            &quot;you&quot; in these Terms, it refers to any user, regardless of
            whether you are a donor or using the Services on behalf of a
            charitable organization, while if we use one of those specific
          ...
          <p>
            ...
            donor must make its own determinations that an organization
            available through our Service is suitable for such donor. Give
            Protocol is only responsible for connecting organizations and
            donors, and is not responsible for the use of any donations.
          </p>

          <h3>
            <strong>5.3 Transaction Fees</strong>
          </h3>
