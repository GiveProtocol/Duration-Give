    ...
    >
      <div className="space-y-8">
        <section>
          ...
          <p>
            GiveProtocol ("we," "our," or "us") is committed to protecting your
            privacy. This Privacy Policy explains how we collect, use, disclose,
            and safeguard your information when you use our blockchain-based
            philanthropic platform and related services (collectively, the
            "Service").
          </p>
          <p>
            We value your privacy and recognize the sensitivity of personal
            data. While blockchain technology enables transparency in donations
            and volunteer contributions, we've designed our platform to balance
          ...
          <p>
            ...
            Privacy Policy. If you provide the personal data of another
            individual (such as organization representatives or volunteer
            references), it means that you have informed them of the purposes
            for which we require their personal data and they have consented to
            the collection, use, and disclosure of their personal data in
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              Blockchain transaction data (wallet addresses, timestamps,
              donation amounts)
            </li>
          ...
          <p>
            ...
            identifiers unless you choose to make such connections publicly
            known.
          </p>
          ...
          <ImportantNotice variant="warning">
            <p>
              <strong>
                ...
                Never trust anyone or any site that asks you to enter your
          ...
          <p>
            ...
            identity. For example, we may aggregate donation data to calculate
            the percentage of users supporting specific causes. If we combine
          ...
          <p>
            ...
            Services). In this case, we may have to cancel a service you have
        ...
        <section>
          ...
          <p>
            Transaction data is publicly visible on the blockchain as part of
