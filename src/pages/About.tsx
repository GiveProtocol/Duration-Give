      ...
      <div className="space-y-16">
        ...
        <section className="grid md:grid-cols-2 gap-8">
          <div className="bg-white p-8 rounded-lg shadow-lg border border-gray-200">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              technology, ensuring transparency, efficiency, and lasting impact
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg border border-gray-200">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              through transparent, efficient, and sustainable giving mechanisms.
            </p>
          </div>
        </section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Enable cryptocurrency donations directly to verified charitable
                organizations with complete transparency.
              </p>
            </div>
            <div className="text-center">
        ...
        <section className="bg-gray-50 rounded-lg p-8 grid md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-600">
              We focus on measurable outcomes and ensure that every contribution
              creates meaningful, lasting change in communities worldwide.
            </p>
          </div>
          <div>
            <h3 className="text-xl font-semibold text-gray-900 mb-4 flex items-center">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Leveraging cutting-edge blockchain technology to solve traditional
              challenges in charitable giving and volunteer coordination.
            </p>
          </div>
        </section>
