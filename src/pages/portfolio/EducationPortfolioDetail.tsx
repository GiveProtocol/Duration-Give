...
const PORTFOLIO = {
  ...
  description:
    "Advancing educational opportunities and access to quality learning worldwide through innovative programs and initiatives.",
  category: "Education",
  totalDonated: 920000,
  image:
...
const CHARITIES = [
  {
    ...
    category: "Education",
    image:
      "https://images.unsplash.com/photo-1509062522246-3755977927d7?auto=format&fit=crop&w=800",
    verified: true,
  ...
  },
  {
    ...
    category: "Education",
    image:
      "https://images.unsplash.com/photo-1584697964358-3e14ca57658b?auto=format&fit=crop&w=800",
    verified: true,
    country: "Rwanda",
    causes: [],
  },
  {
    ...
    category: "Education",
    image:
      "https://images.unsplash.com/photo-1577896851231-70ef18881754?auto=format&fit=crop&w=800",
    verified: true,
    country: "Global",
    causes: [],
  },
  ...
  },
  {
    ...
    description:
      "Advancing science and technology education in developing nations",
    category: "Education",
    image:
