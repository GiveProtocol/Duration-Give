...
describe('CharityVettingForm', () => {
  ...
  it('handles form submission with valid data', async () => {
    ...
    fireEvent.change(screen.getByLabelText(/organization name/i), { target: { value: 'Test Charity' } });
    ...
    fireEvent.change(screen.getByLabelText(/contact email/i), { target: { value: 'john@test.com' } });
  ...
  it('handles registration error', async () => {
    ...
    // Fill minimal data
    fireEvent.change(screen.getByLabelText(/organization name/i), { target: { value: 'Test' } });
  ...
  it('disables submit button when loading', () => {
    jest.mocked(jest.requireMock('@/hooks/useAuth').useAuth).mockReturnValueOnce({
