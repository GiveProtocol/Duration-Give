...
describe("VolunteerHoursVerification", () => {
  ...
  describe("initial state", () => {
    it("renders volunteer information", () => {
      ...
      expect(
        screen.getByText(
          `${testPropsDefaults.volunteerHours.hours} volunteer.hours Formatted: ${testPropsDefaults.volunteerHours.datePerformed}`,
        ),
      ).toBeInTheDocument();
    });
    ...
    it("shows description when provided", () => {
      ...
      expect(
        screen.getByText(testPropsDefaults.volunteerHours.description!),
      ).toBeInTheDocument();
    });
    ...
    it("formats date using date utility", () => {
      ...
      expect(mockFormatDate).toHaveBeenCalledWith(
        testPropsDefaults.volunteerHours.datePerformed,
      );
    });
  });
