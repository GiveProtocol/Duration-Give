          ...
          <div className="space-y-4 mt-4">
            <div className="flex items-start space-x-3">
              ...
              <label htmlFor="essential-processing" className="text-sm">
                ...
                information for the purpose of evaluating my volunteer
                application and, if successful, managing my volunteer
                engagement.
            ...
            <div className="flex items-start space-x-3">
              ...
              <label htmlFor="international-transfers" className="text-sm">
                ...
                I consent to GIVE PROTOCOL transferring my personal information
                to countries outside my country of residence, including
                countries that may not provide the same level of data
                protection, with appropriate safeguards in place as described in
                the Privacy Notice.
              </label>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <label htmlFor="age-confirmation" className="text-sm">
                I confirm that I am at least 16 years of age. (If you are under
                16 years of age, parental or guardian consent is required)
              </label>
            </div>
