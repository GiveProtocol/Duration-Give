...
describe("WalletAliasSettings", () => {
  ...
  const testCases = {
    rendering: [
      {
        name: "renders the wallet alias settings component",
        expectation: () =>
          expect(screen.getByText("Wallet Alias")).toBeInTheDocument(),
      },
      {
        name: "shows current wallet address when connected",
        expectation: () =>
          expect(screen.getByText("0x1234...7890")).toBeInTheDocument(),
      },
      {
        name: "renders the card container",
        expectation: () =>
    ...
    noAlias: [
      {
        name: "shows set alias form by default",
        expectation: () => {
      ...
      {
        name: "allows user to enter alias",
        action: () =>
  ...
  describe("Existing Alias", () => {
    ...
    const existingAliasTests = [
      {
        name: "displays the existing alias",
        expectation: () =>
          expect(screen.getByText("ExistingAlias")).toBeInTheDocument(),
      },
      {
        name: "shows edit and delete buttons",
        expectation: () => {
