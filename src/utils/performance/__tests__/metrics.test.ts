...
describe("PerformanceMetrics", () => {
  ...
  beforeEach(() => {
    ...
    (PerformanceMetrics as unknown as { instance: undefined }).instance =
      undefined;
  ...
  describe("getInstance", () => {
    ...
    it("creates new instance only once", () => {
      expect(PerformanceMetrics.getInstance()).toBeInstanceOf(
        PerformanceMetrics,
      );
    });
  });
  ...
  describe("memory management", () => {
    it("limits number of stored metrics", () => {
      ...
      const storedMetrics = (metrics as unknown as { metrics: unknown[] })
        .metrics;
    ...
    it("removes oldest metrics when limit exceeded", () => {
      ...
      const storedMetrics = (
        metrics as unknown as { metrics: Array<{ name: string }> }
      ).metrics;
